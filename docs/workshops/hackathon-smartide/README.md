...
黑客马拉松的工作区通过 [SmartIDE提供](https://smartide.cn) 提供，讲师会在现场发放环境相关账号信息。
...
| 002 | 在流水线中添加单元测试环节 | 通过现有流水线执行代码中提供的单元测试用例，可以通过Jenkins内置的测试结果视图查看测试结果，如果可以增加一个以上的测试用例，额外加1分。 参考文档 [快速创建Junit测试](../../quick-start/guide/junit-testing/smartide.md) |
