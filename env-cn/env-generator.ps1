...
$toolConfigFilePath= $StagingDirectory + '\k8s\kubernetes.json'
...
$ResourceGroupName = "idcf-$randomString-rg";
...
$toolCmd = $StagingDirectory + "\k8s\aks-engine\aks-engine.exe generate '$toolConfigFilePath' -o '$tempFolder'"
...
az group create --name $ResourceGroupName --location "chinanorth2"
